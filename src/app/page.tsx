  ...
  return (
    <main>
      ...
      <section className="relative bg-yellow-600 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-28 flex items-center gap-10">
          <div className="lg:w-1/2">
            <h2 className="text-4xl font-extrabold leading-tight">
              End-to-end collaboration across the full project lifecycle
            </h2>
            <p className="mt-4 text-lg text-indigo-100">
              Registration → Tendering → Award → Execution → Billing → AMC →
              Help Desk → Analytics
            </p>
            <div className="mt-6 flex gap-3">
              <Link
                href="/vendors"
                className="bg-white text-indigo-600 px-5 py-3 rounded-md font-semibold"
              >
                Explore ecosystem
              </Link>
              <Link
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h3 className="text-xl font-semibold">Lifecycle Collaboration Flow</h3>
          ...
          <div className="mt-4">
            <Link href="/lifecycle" className="text-indigo-600">
